...
#my program produces a slightly different result - mine goes east at (5, 8) instead of north.
#This is because my heuristic determines this is better as east has weight of 33 and north
#weight of 40 - when adding manhattan distance onto this east is better. I could allocate more than 
#value of 1 for each 'city block' (which would correct this), this would not be acceptable as 
#some locations have a value of 1, so doing this could make the heuristic no longer consistent 
def test_world_05():
